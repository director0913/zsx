...
(function (window, document) {
	...
	Wxaudio.prototype = {
		...
		initDom: function () {
			...
			this.wxAudioStateImg.src = '/vendors/images/pause.png'
		...
		initAudioEvent: function () {
			...
			_this.wxAudio.onplaying = function () {
				...
				_this.wxAudioStateImg.src = '/vendors/images/playing.gif'
			},
			_this.wxAudio.onpause = function () {
				_this.isPlaying = false
				_this.showLoading(false)
				_this.wxAudioStateImg.src = '/vendors/images/pause.png'
			},
