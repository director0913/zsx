$(document).ready(function(e) {
	$('#addquerstions').change(function() {
	    ...
	    var node = parseInt($('body').find("[name='node[]']").last().val())+1
	    var Grade = $(".yd_box").find(".movie_box").length + 1;
	    node = node>Grade?node:Grade
	    var biaoti = ''
	    var movie_box = ''
	    var biaoti_title=''
	    switch (index) {
	        case "15": //单选
	        	movie_box = '<div id="wen'+node+'" class="movie_box"><input name="node[]" type="hidden" value="'+node+'"><input name="type'+node+'" type="hidden" value="'+index+'"><input type="hidden" value="'+node+'" name="now_id"><input name="top'+node+'" class="top" type="hidden"><input name="left'+node+'" class="left" type="hidden"><span>是否必填</span><input type="checkbox" value="1" name="is_required'+node+'"></div>';
	        	biaoti = '【单选】';
	        	break
	        case "1": //多选
	        	movie_box = '<div id="wen'+node+'" class="movie_box"><input name="node[]" type="hidden" value="'+node+'"><input name="type'+node+'" type="hidden" value="'+index+'"><input type="hidden" value="'+node+'" name="now_id"><input name="top'+node+'" class="top" type="hidden"><input name="left'+node+'" class="left" type="hidden"><span>是否必填</span><input type="checkbox" value="1" name="is_required'+node+'"></div>';
	        	...
	        	break
	        case "2": //问答
	        	movie_box = '<div id="wen'+node+'" class="movie_box"><input name="node[]" type="hidden" value="'+node+'"><input name="type'+node+'" type="hidden" value="'+index+'"><input name="top'+node+'" class="top" type="hidden"><input name="left'+node+'" class="left" type="hidden"><span>是否必填</span><input type="checkbox" value="1" name="is_required'+node+'"></div>';
	            biaoti = '【问答】';
	            break

	        case "96"://多行文本
	        	movie_box = '<div id="wen'+node+'" class="movie_box"><input name="node[]" type="hidden" value="'+node+'"><input name="type'+node+'" type="hidden" value="'+index+'"><input name="top'+node+'" class="top" type="hidden"><input name="left'+node+'" class="left" type="hidden"><span>是否必填</span><input type="checkbox" value="1" name="is_required'+node+'"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tswjdc_table"><tbody></tbody></table></div>';
	            // var movie_box = ' <div class="wjdc_list"><h4 class="title_wjht"><i class="nmb">' + node + '</i>. 请编辑问题!<span class="tip_wz">【矩阵】</span></h4>'
	            // +' <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tswjdc_table"><tbody></tbody></table></div>';
	            biaoti = '【多行文本】';
	            break;    
	        case "13"://单行文本
				movie_box = '<div id="wen'+node+'" class="movie_box"><input name="node[]" type="hidden" value="'+node+'"><input name="type'+node+'" type="hidden" value="'+index+'"><input name="top'+node+'" class="top" type="hidden"><input name="left'+node+'" class="left" type="hidden"><span>是否必填</span><input type="checkbox" value="1" name="is_required'+node+'"></div>';
				...
				break
			case "9"://姓名
				movie_box = '<div id="wen'+node+'" class="movie_box"><input name="node[]" type="hidden" value="'+node+'"><input name="type'+node+'" type="hidden" value="'+index+'"><input name="top'+node+'" class="top" type="hidden"><input name="left'+node+'" class="left" type="hidden"><span>是否必填</span><input type="checkbox" value="1" name="is_required'+node+'"><span>姓名：</span></div>';
				biaoti = '【姓名】';
				break
			case "8"://网址
				movie_box = '<div id="wen'+node+'" class="movie_box"><input name="node[]" type="hidden" value="'+node+'"><input name="type'+node+'" type="hidden" value="'+index+'"><input name="top'+node+'" class="top" type="hidden"><input name="left'+node+'" class="left" type="hidden"><span>是否必填</span><input type="checkbox" value="1" name="is_required'+node+'"><span>网址：</span></div>';
				biaoti = '【网址】';
				break
			case "10"://手机号
				movie_box = '<div id="wen'+node+'" class="movie_box"><input name="node[]" type="hidden" value="'+node+'"><input name="type'+node+'" type="hidden" value="'+index+'"><input name="top'+node+'" class="top" type="hidden"><input name="left'+node+'" class="left" type="hidden"><span>是否必填</span><input type="checkbox" value="1" name="is_required'+node+'"><span>手机号：</span></div>';
				biaoti = '【手机号】';
				break
			case "11"://地址
				movie_box = '<div id="wen'+node+'" class="movie_box"><input name="node[]" type="hidden" value="'+node+'"><input name="type'+node+'" type="hidden" value="'+index+'"><input name="top'+node+'" class="top" type="hidden"><input name="left'+node+'" class="left" type="hidden"><span>是否必填</span><input type="checkbox" value="1" name="is_required'+node+'"><span>地址：</span></div>';
				biaoti = '【地址】';
				break
			case "12"://电话
				movie_box = '<div id="wen'+node+'" class="movie_box"><input name="node[]" type="hidden" value="'+node+'"><input name="type'+node+'" type="hidden" value="'+index+'"><input name="top'+node+'" class="top" type="hidden"><input name="left'+node+'" class="left" type="hidden"><span>是否必填</span><input type="checkbox" value="1" name="is_required'+node+'"></div>';
				biaoti = '【电话】';
				break
			case "7"://日期<input type="text" name="date" size="20" value＝""  class="easyui-datebox"/> 
				
				movie_box = '<div id="wen'+node+'" class="movie_box"><input name="node[]" type="hidden" value="'+node+'"><input name="type'+node+'" type="hidden" value="'+index+'"><input name="top'+node+'" class="top" type="hidden"><input name="left'+node+'" class="left" type="hidden"><span>是否必填</span><input type="checkbox" value="1" name="is_required'+node+'"></div>';	  
				biaoti = '【日期】';
				break
			case "5"://单张照片
				movie_box = '<div id="wen'+node+'" class="movie_box"><input name="node[]" type="hidden" value="'+node+'"><input name="type'+node+'" type="hidden" value="'+index+'"><input name="top'+node+'" class="top" type="hidden"><input name="left'+node+'" class="left" type="hidden"><span>是否必填</span><input type="checkbox" value="1" name="is_required'+node+'"><input type="text" name="wen'+node+'" value="上传图片"><input type="file" name="file'+node+'"></div>';
				biaoti = '【单张照片】';
				break
			case "6"://多张照片
				movie_box = '<div id="wen'+node+'" class="movie_box"><input name="node[]" type="hidden" value="'+node+'"><input name="type'+node+'" type="hidden" value="'+index+'"><input name="top'+node+'" class="top" type="hidden"><input name="left'+node+'" class="left" type="hidden"><span>是否必填</span><input type="checkbox" value="1" name="is_required'+node+'"><input type="text" name="wen'+node+'" value="上传图片"><input type="file" name="file'+node+'[]"></div>';
	    ...
	    if (movie_box) {
            ...
            wjdc_list = $(wjdc_list).append(' <li><div class="tm_btitlt"><i class="nmb">' + Grade + '</i><i class="btwenzi"><h4>'+biaoti+'</h4><input><input class="biaoti_title" type="hidden" name="biaoti_title'+node+'"></i></div></li>');
            if (index == "2") {
...
/*	$(".btwen_text").val("题目");
	...
	$(".bianji").live("click", function() {
		...
		var jztm = $(".jztm").html();
		//接受编辑内容的容器
		//console.log($(this).parent().parent().find('.wjdc_list .tm_btitlt .btwenzi h4').html())
		console.log(tktm)
		...
		if(title == 1) {
			...
			//赋值文本框 
			//题目标题
			var texte_bt_val = $(this).parent(".kzqy_czbut").parent(".movie_box").find(".wjdc_list").children("li").eq(0).find(".tm_btitlt").children(".btwenzi").find('input').val();
			dx_rq.find(".btwen_text").val(texte_bt_val);
			//遍历题目项目的文字
			var bjjs = 0;
			$(this).parent(".kzqy_czbut").parent(".movie_box").find(".wjdc_list").children("li").each(function() {
		...
		//填空题目
		if(title == 12 || title == 10 || title == 11 || title == 9 || title == 8 || title == 13 || title == 96 || title == 5 || title == 6) {
			dx_rq.show().html(tktm);
			//赋值文本框 
			//题目标题
			var texte_bt_val = $(this).parent(".kzqy_czbut").parent(".movie_box").find(".wjdc_list").children("li").eq(0).find(".tm_btitlt").children(".btwenzi").find('h4').html();
			dx_rq.find(".btwen_text").val(texte_bt_val);
		}
		//矩阵题目
		if(title == 3) {
	...
	$(".swcbj_but").live("click", function() {
		//当前id值
		var now_id = $(this).parent().parent().parent().find("[name='now_id']").val()
		...
		switch(querstionType) {
			...
			case "1": //多选	
				...
				jcxxxx.parent(".movie_box").children(".wjdc_list").children("li").eq(0).find(".tm_btitlt").children(".btwenzi").find('input').val(texte_bt_val_bj); //将修改过的问题题目展示
				...
				jcxxxx.children(".title_itram").children(".kzjxx_iteam").each(function() {
					...
					var li = '<li><label><input name="a" type="' + inputType + '" value=""><input type="hidden" value="' + texte_val_bj + '" name="duoxuan_option'+now_id+'[]"><span>' + texte_val_bj + '</span></label></li>';
			...
			case "6":
				var texte_bt_val_bj = jcxxxx.find(".btwen_text").val(); //获取问题题目
				jcxxxx.parent(".movie_box").children(".wjdc_list").children("li").eq(0).find(".tm_btitlt").children(".btwenzi").children(".biaoti_title").val(texte_bt_val_bj); //将修改过的问题题目展示
				jcxxxx.parent(".movie_box").children(".wjdc_list").children("li").eq(0).find(".tm_btitlt").children(".btwenzi").children("h4").html(texte_bt_val_bj); //将修改过的问题题目展示
				break;
