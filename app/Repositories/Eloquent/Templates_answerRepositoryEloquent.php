 ...
 * 角色仓库
 */
class Templates_answerRepositoryEloquent extends BaseRepository
{
    /**
     ...
     */
    public function getTemplates_answerList($start,$length,$search,$order)
    {
        $role = $this->model;
        if ($search) {
